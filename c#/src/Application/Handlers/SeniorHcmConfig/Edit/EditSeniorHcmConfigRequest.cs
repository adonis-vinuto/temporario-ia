...
public record EditSeniorHcmConfigRequest(
    string? Username,
    string? Password,
    string? WsdlUrl
)
...
public class EditSeniorHcmConfigRequestValidator : AbstractValidator<EditSeniorHcmConfigRequest>
{
    public EditSeniorHcmConfigRequestValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty()
